      ...
      <BrowserRouter>
        <nav class='   z-10 w-full shadow bg-black'>
          <div class='container flex items-center justify-center p-6  text-gray-600 capitalize dark:text-gray-300'>
            ...
            <AnchorLink
              href='#about_me'
              className='border-b-2 border-transparent hover:text-gray-800 transition-colors  transform dark:hover:text-green-400 hover:border-blue-500 mx-1.5 sm:mx-6'></AnchorLink>
            <AnchorLink href='#about_me'>
